...
//						}
				...
				if(json.has(Const.STA_MEMBERS)){
					...
					ViewGroup care_container = (ViewGroup)view.findViewById(R.id.care_container);
					for (int i = 0 ; i < 7; i++){
						
//						ViewStub vs = (ViewStub)care_container.getChildAt(i);
...
//						ImageView careItem = (ImageView) vs.inflate();
						...
						if(careCount > 7){
							...
							if(i == 6){
								...
								imgUrl = member.optString(Const.STA_IMGURL, imgUrl);
