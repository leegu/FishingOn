...
import com.go.fish.barcode.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
  ...
  private final ICallback activity;
  ...
  public CaptureActivityHandler(ICallback activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
